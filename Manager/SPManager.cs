...
namespace DeWee.Manager
{
	public static partial class SPManager
	{
		...
		public static DataTable SP_GetPerformingDistricts()
		{
			StoredProcedure sp = new StoredProcedure("SP_GetPerformingDistricts");
			DataTable dt = sp.ExecuteDataSet().Tables[0];
			return dt;
		}
		public static DataTable SP_GetDistrictsWith_SolarShopsMapped()
		{
			StoredProcedure sp = new StoredProcedure("SP_GetDistrictsWith_SolarShopsMapped");
			DataTable dt = sp.ExecuteDataSet().Tables[0];
			return dt;
		}
